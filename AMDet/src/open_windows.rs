...
pub fn get_pos_open_table() -> WinInf {
    get_pos_window("Форма заполнения таблиц")
}

pub fn get_pos_maket() -> WinInf {
    get_pos_window("Виртуальная лабораторная работа \"Исследование амплитудного детектора\"")
}

pub fn get_pos_init() -> WinInf {
    get_pos_window("Загрузка исходных данных")
}
