...
impl Meme {
    ...
    pub fn vm(&self) -> f32 {
        ...
        let mut volt = 0f32;
        read(self.handle, VM_ADRR, &mut volt);
    ...
    pub fn fv(&self) -> f32 {
        let mut freq = 0f32;
        read(self.handle, FV_ADRR, &mut freq);
    ...
    pub fn vg(&self) -> f32 {
        let mut volt = 0f32;
        read(self.handle, VG_ADRR, &mut volt);
    ...
    pub fn fd(&self) -> f32 {
        let mut f = 0f32;
        read(self.handle, DIV_ADRR, &mut f);
        f
    }

    pub fn kg(&self) -> f32 {
        let mut k = 0f32;
        read(self.handle, KG_ADRR, &mut k);
        k
    }

    pub fn band(&self) -> f32 {
        let mut b = 0f32;
        read(self.handle, BAND_ADRR, &mut b);
        b * 1000.
    }
